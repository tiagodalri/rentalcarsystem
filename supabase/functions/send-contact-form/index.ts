...
<html><head><meta charset="utf-8"><title>Contato GoDrive</title></head>
<body style="font-family:Arial,sans-serif;background:#f9f9f9;padding:30px;">
  <div style="max-width:600px;margin:0 auto;background:#fff;border-radius:8px;padding:30px;border:1px solid #e0e0e0;">
    <h2 style="color:#0a0a0a;border-bottom:2px solid #d4af37;padding-bottom:10px;">Nova mensagem do site GoDrive</h2>
    ...
    const resp = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: "GoDrive <contato@rentalcarsystem.lovable.app>",
        to: [recipient],
        reply_to: email,
