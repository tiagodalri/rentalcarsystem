...
// tailored to the Zeus Rental Car brand and current generator context.
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const sys = `Voce e diretor de criacao senior (Apple, Aesop, Mr Porter, Wieden+Kennedy) trabalhando para a Zeus Rental Car — locadora premium em Orlando, publico brasileiro.
