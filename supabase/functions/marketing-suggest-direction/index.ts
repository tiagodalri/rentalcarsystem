...
// tailored to the Rental Studio brand and current generator context.
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const sys = `Voce e diretor de criacao senior (Apple, Aesop, Mr Porter, Wieden+Kennedy) trabalhando para a Rental Studio — locadora premium em Orlando, publico brasileiro.
