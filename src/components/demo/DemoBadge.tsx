...
export function DemoBadge() {
  ...
  return (
    <div
      className="pointer-events-none fixed bottom-3 right-3 z-[70] hidden sm:flex items-center gap-1.5 rounded-full px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.22em] shadow-lg"
      style={{
