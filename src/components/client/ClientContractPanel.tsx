  ...
  switch (status) {
    ...
    case "partially_signed":
      ...
      body = (
        <>
          <p className="text-xs text-muted-foreground mb-3">
            O contrato foi gerado e pré-assinado pela Zeus Rental Car. Falta apenas a sua assinatura para concluir.
          </p>
          <button
    ...
    case "failed":
      ...
      body = (
        <p className="text-xs text-muted-foreground">
          Algo deu errado. Fale com a Zeus Rental Car pelo WhatsApp e geraremos novamente.
        </p>
      );
      break;
    case "cancelled":
    ...
    default:
      ...
      body = (
        <p className="text-xs text-muted-foreground">
          Assim que o pagamento for confirmado, o contrato é gerado, pré-assinado pela Zeus e enviado para sua assinatura.
        </p>
      );
  }
