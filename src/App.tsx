...
const BrainAccessGate = lazy(() => import("./components/admin/zeus-brain/BrainAccessGate.tsx"));
          ...
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route path="/admin" element={<Suspense fallback={<AdminShellSkeleton />}><AdminLayout /></Suspense>}>
                ...
                <Route path="zeus-brain/simulador" element={<RequireRole roles={["admin","finance","operations"]}><AdminSuspense><BrainAccessGate><AiSimulador /></BrainAccessGate></AdminSuspense></RequireRole>} />
