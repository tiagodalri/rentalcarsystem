...
export const translations: Record<Language, TranslationKeys> = {
  pt: {
    nav: {
      ...
      whyZeus: "Por que a Rental Studio?",
      contact: "Contato",
      book: "Reservar",
    ...
    about: {
      ...
      description: "A Rental Studio é referência em locação de veículos premium para brasileiros em Orlando. Oferecemos uma experiência de mobilidade de alto nível, com atendimento personalizado, frota selecionada e o melhor custo-benefício do mercado. porque serviço premium não precisa custar caro.",
    ...
    fleet: {
      sectionTag: "Frota Rental Studio",
    ...
    deals: {
      ...
      subtitle: "Quanto mais tempo com a Rental Studio, mais vantagem para você.",
      discount5: "2 a 5 dias de locação",
      discount10: "Reservas acima de 10 diárias",
    },
    whyZeus: {
      title: "Por que escolher a ",
      titleHighlight: "Rental Studio?",
    ...
    testimonials: {
      ...
      t1Name: "Ricardo M.",
      t1Text: "Experiência incrível! O carro estava impecável e o atendimento em português fez toda diferença. Super recomendo a Rental Studio!",
      t2Name: "Fernanda S.",
      t2Text: "Alugamos um Escalade para a família e foi perfeito. Processo super simples, sem burocracia. Voltaremos com certeza!",
      t3Name: "Carlos A.",
      t3Text: "Realizei o sonho de dirigir um Corvette em Orlando. A Rental Studio tornou tudo fácil e seguro. Nota 10!",
      t4Name: "Juliana P.",
    ...
    footer: {
      tagline: "Rental Studio. Concierge premium para brasileiros em Orlando.",
      whatsapp: "Fale Conosco no WhatsApp",
      rights: "© 2026 Rental Studio. Todos os direitos reservados.",
    },
    vehicles: {
  ...
  en: {
    ...
    about: {
      ...
      description: "Rental Studio is a reference in premium vehicle rental for Brazilians in Orlando. We offer a high-level mobility experience with personalized service, a curated fleet, and the best value for money in the market. because premium service doesn't have to cost a fortune.",
    ...
    fleet: {
      sectionTag: "Rental Studio Fleet",
    ...
    deals: {
      ...
      subtitle: "The longer you stay with Rental Studio, the more you save.",
    ...
    testimonials: {
      ...
      t1Name: "Ricardo M.",
      t1Text: "Incredible experience! The car was impeccable and the Portuguese-speaking service made all the difference. Highly recommend Rental Studio!",
      t2Name: "Fernanda S.",
      ...
      t3Name: "Carlos A.",
      t3Text: "I fulfilled my dream of driving a Corvette in Orlando. Rental Studio made everything easy and safe. 10/10!",
      t4Name: "Juliana P.",
    ...
    footer: {
      tagline: "Rental Studio. Premium concierge for Brazilians in Orlando.",
      whatsapp: "Contact Us on WhatsApp",
      rights: "© 2026 Rental Studio. All rights reserved.",
    },
    vehicles: {
  ...
  es: {
    ...
    about: {
      title: "Quiénes ",
      titleHighlight: "Somos",
      description: "Rental Studio es referencia en alquiler de vehículos premium para brasileños en Orlando. Ofrecemos una experiencia de movilidad de alto nivel, con atención personalizada, flota seleccionada y la mejor relación calidad-precio del mercado. porque el servicio premium no tiene que ser caro.",
    ...
    fleet: {
      sectionTag: "Flota Rental Studio",
    ...
    deals: {
      ...
      subtitle: "Cuanto más tiempo con Rental Studio, más ahorras.",
    ...
    testimonials: {
      ...
      t1Name: "Ricardo M.",
      t1Text: "¡Experiencia increíble! El auto estaba impecable y la atención en portugués hizo toda la diferencia. ¡Super recomiendo Rental Studio!",
      t2Name: "Fernanda S.",
      t2Text: "Alquilamos un Escalade para la familia y fue perfecto. Proceso super simple, sin burocracia. ¡Volveremos seguro!",
      t3Name: "Carlos A.",
      t3Text: "Cumplí el sueño de conducir un Corvette en Orlando. Rental Studio hizo todo fácil y seguro. ¡Nota 10!",
      t4Name: "Juliana P.",
    ...
    footer: {
      tagline: "Rental Studio. Concierge premium para brasileños en Orlando.",
      whatsapp: "Contáctenos por WhatsApp",
      rights: "© 2026 Rental Studio. Todos los derechos reservados.",
    },
    vehicles: {
  ...
  it: {
    ...
    fleet: {
      sectionTag: "Flotta Rental Studio",
    ...
    deals: {
      ...
      subtitle: "Più tempo con Rental Studio, più risparmi.",
    ...
    testimonials: {
      ...
      t1Name: "Ricardo M.",
      t1Text: "Esperienza incredibile! L'auto era impeccabile e il servizio in portoghese ha fatto tutta la differenza. Super consiglio Rental Studio!",
      t2Name: "Fernanda S.",
      ...
      t3Name: "Carlos A.",
      t3Text: "Ho realizzato il sogno di guidare una Corvette a Orlando. Rental Studio ha reso tutto facile e sicuro. Voto 10!",
      t4Name: "Juliana P.",
    ...
    footer: {
      tagline: "Rental Studio. Concierge premium per brasiliani a Orlando.",
      whatsapp: "Contattaci su WhatsApp",
      rights: "© 2026 Rental Studio. Tutti i diritti riservati.",
    },
    vehicles: {
  ...
  de: {
    ...
    about: {
      title: "Wer wir ",
      titleHighlight: "sind",
      description: "Rental Studio ist eine Referenz im Premium-Fahrzeugverleih für Brasilianer in Orlando. Wir bieten ein erstklassiges Mobilitätserlebnis mit persönlichem Service, einer ausgewählten Flotte und dem besten Preis-Leistungs-Verhältnis auf dem Markt. denn Premium-Service muss nicht teuer sein.",
    ...
    fleet: {
      sectionTag: "Rental Studio Flotte",
    ...
    deals: {
      ...
      subtitle: "Je länger bei Rental Studio, desto mehr sparen Sie.",
      discount5: "2 bis 5 Miettage",
      discount10: "Buchungen über 10 Tage",
    },
    whyZeus: {
      title: "Warum ",
      titleHighlight: "Rental Studio wählen?",
    ...
    testimonials: {
      ...
      t3Name: "Carlos A.",
      t3Text: "Ich habe meinen Traum erfüllt, eine Corvette in Orlando zu fahren. Rental Studio hat alles einfach und sicher gemacht. Note 10!",
      t4Name: "Juliana P.",
    ...
    footer: {
      tagline: "Rental Studio. Premium-Concierge für Brasilianer in Orlando.",
      whatsapp: "Kontaktieren Sie Uns auf WhatsApp",
      rights: "© 2026 Rental Studio. Alle Rechte vorbehalten.",
    },
    vehicles: {
  ...
  fr: {
    nav: {
      ...
      whyZeus: "Pourquoi Rental Studio ?",
      contact: "Contact",
      book: "Réserver",
    ...
    fleet: {
      sectionTag: "Flotte Rental Studio",
    ...
    deals: {
      ...
      subtitle: "Plus longtemps avec Rental Studio, plus vous économisez.",
    ...
    testimonials: {
      ...
      t1Name: "Ricardo M.",
      t1Text: "Expérience incroyable ! La voiture était impeccable et le service en portugais a fait toute la différence. Je recommande vivement Rental Studio !",
      t2Name: "Fernanda S.",
      ...
      t3Name: "Carlos A.",
      t3Text: "J'ai réalisé mon rêve de conduire une Corvette à Orlando. Rental Studio a rendu tout facile et sûr. Note 10 !",
      t4Name: "Juliana P.",
    ...
    footer: {
      tagline: "Rental Studio. Concierge premium pour les Brésiliens à Orlando.",
      whatsapp: "Contactez-Nous sur WhatsApp",
      rights: "© 2026 Rental Studio. Tous droits réservés.",
    },
    vehicles: {
