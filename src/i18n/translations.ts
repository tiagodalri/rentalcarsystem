...
export const translations: Record<Language, TranslationKeys> = {
  pt: {
    ...
    about: {
      ...
      description: "A Sua Marca é referência em locação de veículos premium para brasileiros em Orlando. Oferecemos uma experiência de mobilidade de alto nível, com atendimento personalizado, frota selecionada e o melhor custo-benefício do mercado. porque serviço premium não precisa custar caro.",
    ...
    deals: {
      ...
      subtitle: "Quanto mais tempo com a Sua Marca, mais vantagem para você.",
    ...
    testimonials: {
      ...
      t1Name: "Ricardo M.",
      t1Text: "Experiência incrível! O carro estava impecável e o atendimento em português fez toda diferença. Super recomendo a Sua Marca!",
      t2Name: "Fernanda S.",
      t2Text: "Alugamos um Escalade para a família e foi perfeito. Processo super simples, sem burocracia. Voltaremos com certeza!",
      t3Name: "Carlos A.",
      t3Text: "Realizei o sonho de dirigir um Corvette em Orlando. A Sua Marca tornou tudo fácil e seguro. Nota 10!",
      t4Name: "Juliana P.",
    ...
    footer: {
      tagline: "Sua Marca. Concierge premium para brasileiros em Orlando.",
      whatsapp: "Fale Conosco no WhatsApp",
      rights: "© 2026 Sua Marca. Todos os direitos reservados.",
    },
    vehicles: {
  ...
  en: {
    ...
    about: {
      ...
      description: "Sua Marca is a reference in premium vehicle rental for Brazilians in Orlando. We offer a high-level mobility experience with personalized service, a curated fleet, and the best value for money in the market. because premium service doesn't have to cost a fortune.",
    ...
    deals: {
      ...
      subtitle: "The longer you stay with Sua Marca, the more you save.",
    ...
    testimonials: {
      ...
      t1Name: "Ricardo M.",
      t1Text: "Incredible experience! The car was impeccable and the Portuguese-speaking service made all the difference. Highly recommend Sua Marca!",
      t2Name: "Fernanda S.",
      ...
      t3Name: "Carlos A.",
      t3Text: "I fulfilled my dream of driving a Corvette in Orlando. Sua Marca made everything easy and safe. 10/10!",
      t4Name: "Juliana P.",
    ...
    footer: {
      tagline: "Sua Marca. Premium concierge for Brazilians in Orlando.",
      whatsapp: "Contact Us on WhatsApp",
      rights: "© 2026 Sua Marca. All rights reserved.",
    },
    vehicles: {
  ...
  es: {
    ...
    about: {
      title: "Quiénes ",
      titleHighlight: "Somos",
      description: "Sua Marca es referencia en alquiler de vehículos premium para brasileños en Orlando. Ofrecemos una experiencia de movilidad de alto nivel, con atención personalizada, flota seleccionada y la mejor relación calidad-precio del mercado. porque el servicio premium no tiene que ser caro.",
    ...
    deals: {
      ...
      subtitle: "Cuanto más tiempo con Sua Marca, más ahorras.",
    ...
    testimonials: {
      ...
      t1Name: "Ricardo M.",
      t1Text: "¡Experiencia increíble! El auto estaba impecable y la atención en portugués hizo toda la diferencia. ¡Super recomiendo Sua Marca!",
      t2Name: "Fernanda S.",
      t2Text: "Alquilamos un Escalade para la familia y fue perfecto. Proceso super simple, sin burocracia. ¡Volveremos seguro!",
      t3Name: "Carlos A.",
      t3Text: "Cumplí el sueño de conducir un Corvette en Orlando. Sua Marca hizo todo fácil y seguro. ¡Nota 10!",
      t4Name: "Juliana P.",
    ...
    footer: {
      tagline: "Sua Marca. Concierge premium para brasileños en Orlando.",
      whatsapp: "Contáctenos por WhatsApp",
      rights: "© 2026 Sua Marca. Todos los derechos reservados.",
    },
    vehicles: {
  ...
  it: {
    ...
    about: {
      ...
      description: "Sua Marca è un riferimento nel noleggio di veicoli premium per brasiliani a Orlando. Offriamo un'esperienza di mobilità di alto livello, con servizio personalizzato, flotta selezionata e il miglior rapporto qualità-prezzo sul mercato. perché il servizio premium non deve costare una fortuna.",
    ...
    deals: {
      ...
      subtitle: "Più tempo con Sua Marca, più risparmi.",
    ...
    testimonials: {
      ...
      t1Name: "Ricardo M.",
      t1Text: "Esperienza incredibile! L'auto era impeccabile e il servizio in portoghese ha fatto tutta la differenza. Super consiglio Sua Marca!",
      t2Name: "Fernanda S.",
      ...
      t3Name: "Carlos A.",
      t3Text: "Ho realizzato il sogno di guidare una Corvette a Orlando. Sua Marca ha reso tutto facile e sicuro. Voto 10!",
      t4Name: "Juliana P.",
    ...
    footer: {
      tagline: "Sua Marca. Concierge premium per brasiliani a Orlando.",
      whatsapp: "Contattaci su WhatsApp",
      rights: "© 2026 Sua Marca. Tutti i diritti riservati.",
    },
    vehicles: {
  ...
  de: {
    ...
    about: {
      title: "Wer wir ",
      titleHighlight: "sind",
      description: "Sua Marca ist eine Referenz im Premium-Fahrzeugverleih für Brasilianer in Orlando. Wir bieten ein erstklassiges Mobilitätserlebnis mit persönlichem Service, einer ausgewählten Flotte und dem besten Preis-Leistungs-Verhältnis auf dem Markt. denn Premium-Service muss nicht teuer sein.",
    ...
    deals: {
      ...
      subtitle: "Je länger bei Sua Marca, desto mehr sparen Sie.",
      discount5: "2 bis 5 Miettage",
      discount10: "Buchungen über 10 Tage",
    },
    whyZeus: {
      title: "Warum ",
      titleHighlight: "Sua Marca wählen?",
    ...
    testimonials: {
      ...
      t3Name: "Carlos A.",
      t3Text: "Ich habe meinen Traum erfüllt, eine Corvette in Orlando zu fahren. Sua Marca hat alles einfach und sicher gemacht. Note 10!",
      t4Name: "Juliana P.",
    ...
    footer: {
      tagline: "Sua Marca. Premium-Concierge für Brasilianer in Orlando.",
      whatsapp: "Kontaktieren Sie Uns auf WhatsApp",
      rights: "© 2026 Sua Marca. Alle Rechte vorbehalten.",
    },
    vehicles: {
  ...
  fr: {
    ...
    deals: {
      ...
      subtitle: "Plus longtemps avec Sua Marca, plus vous économisez.",
    ...
    testimonials: {
      ...
      t1Name: "Ricardo M.",
      t1Text: "Expérience incroyable ! La voiture était impeccable et le service en portugais a fait toute la différence. Je recommande vivement Sua Marca !",
      t2Name: "Fernanda S.",
      ...
      t3Name: "Carlos A.",
      t3Text: "J'ai réalisé mon rêve de conduire une Corvette à Orlando. Sua Marca a rendu tout facile et sûr. Note 10 !",
      t4Name: "Juliana P.",
    ...
    footer: {
      tagline: "Sua Marca. Concierge premium pour les Brésiliens à Orlando.",
      whatsapp: "Contactez-Nous sur WhatsApp",
      rights: "© 2026 Sua Marca. Tous droits réservés.",
    },
    vehicles: {
