...
export const adminTutorials: Tutorial[] = [
  ...
  {
    id: "primeiro-dia",
    title: "Boas-vindas: seu primeiro dia na Rental Studio",
    summary:
    ...
    steps: [
      {
        title: "Bem-vindo, Rui",
        body:
          "Este painel é o seu posto de comando. Tudo que acontece com os carros e clientes da Rental Studio passa por aqui. Vou te mostrar exatamente onde olhar e por quê — leve no seu ritmo, pode pausar e voltar quando quiser.",
        imageRef: "opsToday",
        hotspots: [
          { n: 1, x: 8.5, y: 5, w: 16, h: 7, label: "Logo Rental Studio — clique para voltar ao painel a qualquer momento" },
          { n: 2, x: 8.5, y: 96, w: 17, h: 6, label: "Seu usuário e atalho para sair" },
        ],
        caption:
          "Regra de ouro: na dúvida, registre. Foto, observação, marcação de avaria — registrar sempre protege você, o cliente e a Rental Studio.",
      },
      {
        ...
        hotspots: [
          ...
          { n: 4, x: 8.5, y: 45.5, w: 17, h: 4.5, label: "Frota — situação de cada veículo da Rental Studio" },
  ...
  // ────────────────────────────────────────────────────────────────────────────
  {
    ...
    summary:
      "Respostas rápidas para as situações que mais aparecem no balcão da Rental Studio.",
    icon: CircleHelp,
    duration: 5,
    category: "Diário",
    steps: [
