...
const AboutUs = () => {
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      <Seo
        title="Sobre Nós | Rental Studio Orlando"
        description="Conheça a Rental Studio: locadora premium em Orlando que une hospitalidade brasileira e padrão de serviço internacional. Confiança, transparência e excelência em cada detalhe."
        path="/sobre-nos"
      />
      <Navbar />
          ...
          >
            ...
            <div className="space-y-6 text-lg sm:text-xl leading-relaxed text-muted-foreground italic">
              <p className="text-foreground font-semibold not-italic text-2xl sm:text-3xl">
                A Rental Studio existe porque alguém decidiu que brasileiro em Orlando merece mais.
              </p>
