...
export default function AdminCustomers() {
  ...
  const load = async () => {
    ...
    const { data: customersData } = await supabase
      .from("customers")
      .select("id, full_name, email, phone, document_number, nationality, date_of_birth, address, house_number, complement, zip_code, driver_license, driver_license_expiry, driver_license_file_url, driver_license_verified_at, created_at, user_id")
      .order("full_name");
