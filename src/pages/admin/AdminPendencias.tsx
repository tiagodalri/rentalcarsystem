      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <Card className="bg-card/50 border-border/40">
          <CardContent className="pt-5">
            ...
            <p className="admin-kpi text-3xl mt-1 tabular-nums">{totalPendencias}</p>
          </CardContent>
        </Card>
        <Card className="bg-card/50 border-border/40">
          <CardContent className="pt-5">
            <p className="text-xs text-muted-foreground uppercase tracking-wider">Veículos com pendências</p>
            <p className="admin-kpi text-3xl mt-1 tabular-nums">{byVehicle.length}</p>
          </CardContent>
        </Card>
        <Card className="bg-card/50 border-border/40">
          <CardContent className="pt-5">
            <p className="text-xs text-muted-foreground uppercase tracking-wider">Veículos completos</p>
            <p className="admin-kpi text-3xl mt-1 tabular-nums">{vehicles.length - byVehicle.length}</p>
          </CardContent>
        </Card>
      </div>
