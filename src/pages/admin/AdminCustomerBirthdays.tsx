...
function birthdayGreeting(name: string, lang: string | null) {
  ...
  switch ((lang || "pt").toLowerCase()) {
    case "en":
      return `Hi ${first}! Everyone at Rental Studio wishes you a happy birthday — a year full of safe roads, new adventures and unforgettable moments. We have a special treat waiting for you. Talk soon!`;
    case "es":
      return `¡Hola ${first}! Todo el equipo de Rental Studio te desea un muy feliz cumpleaños — un año lleno de caminos seguros, nuevas aventuras y momentos inolvidables. Tenemos un mimo especial para ti. ¡Nos hablamos pronto!`;
    default:
      return `Olá ${first}! Todo o time da Rental Studio te deseja um feliz aniversário — um ano cheio de boas estradas, novas aventuras e momentos inesquecíveis. Temos um mimo especial reservado pra você. Falamos em breve!`;
  }
}
