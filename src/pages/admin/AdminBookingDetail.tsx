        ...
        <div className="w-full lg:w-auto lg:min-w-[360px] space-y-2">
          <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap lg:justify-end">
            {booking.customer_phone && (
              <a
                href={`https://wa.me/${booking.customer_phone.replace(/\D/g, "")}?text=${encodeURIComponent(`Olá ${formatPersonName(booking.customer_name) || ""}, aqui é da Rental Studio sobre sua reserva ${booking.booking_number || ""}.`)}`}
                target="_blank"
                rel="noopener noreferrer"
