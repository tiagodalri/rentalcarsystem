...
const REGIONS = {
  ...
  jacksonville: { center: [30.3322, -81.6557] as [number, number], radius: 0.10 },
  daytonaBeach: { center: [29.2108, -81.0228] as [number, number], radius: 0.08 },
...
const FLEET_SEED: Omit<TrackedVehicle, "lat" | "lng" | "speed" | "heading" | "battery" | "lastUpdate" | "status">[] = [
  ...
  { id: "v4", name: "BMW X5 M Sport", plate: "ZEU-0008", region: "jacksonville" },
  ...
  { id: "v8", name: "Kia Sportage", plate: "ZEU-0044", region: "daytonaBeach" },
  { id: "v9", name: "Mitsubishi Outlander", plate: "ZEU-0061", region: "miami" },
  { id: "v10", name: "Volkswagen Tiguan", plate: "ZEU-0037", region: "jacksonville" },
  { id: "v11", name: "Chrysler Pacifica", plate: "ZEU-0072", region: "orlando" },
  { id: "v12", name: "Lexus NX", plate: "ZEU-0015", region: "daytonaBeach" },
