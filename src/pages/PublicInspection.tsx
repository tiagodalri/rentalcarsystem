...
export default function PublicInspection() {
  ...
  if (state.status === "error") {
    const errMap: Record<string, string> = {
      ...
      revoked: "Este link foi revogado pela equipe GoDrive.",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-5 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <p className="text-[10px] uppercase tracking-[0.2em] text-background/60 print:text-black/60">GoDrive</p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 space-y-5">
        ...
        <section className="rounded-2xl border border-border bg-card p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { url: inspection.agent_signature, label: "Agente GoDrive", name: inspection.agent_name },
        ...
        <footer className="text-center text-[11px] text-muted-foreground pt-2 pb-6">
          Documento gerado por GoDrive • Link público compartilhado pela equipe.
        </footer>
      </div>
    </div>
  );
